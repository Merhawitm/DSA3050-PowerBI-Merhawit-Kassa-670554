...
![Headers Fixed](screenshots/power_query/02_headers_fixed.png)
*Column headers corrected using Use First Row as Headers.*

![Data Types](screenshots/power_query/03_data_types.png)
*Corrected data types for InvoiceDate, Customer ID, and Price.*

![Duplicates Removed](screenshots/power_query/04_duplicates_removed.png)
*Duplicate rows removed via Remove Duplicates.*

![Cleaning Flags](screenshots/power_query/05_cleaning_flags.png)
*Cancelled, TransactionType, and PriceFlag columns added.*

![Customer ID Handling](screenshots/power_query/06_customer_id_handling.png)
*CustomerStatus and Customer ID Clean columns resolving missing customer identifiers.*

![Country Standardized](screenshots/power_query/07_country_standardized.png)
*Country field standardized (EIRE→Ireland, RSA→South Africa, USA→United States).*
...
└── screenshots/
    ├── power_query/
    │   ├── 01_raw_data.png
    │   ├── 02_headers_fixed.png
    │   ├── 03_data_types.png
    │   ├── 04_duplicates_removed.png
    │   ├── 05_cleaning_flags.png
    │   ├── 06_customer_id_handling.png
